...
function AcceptBid() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await acceptBid(formData);
      ...
      toast.error(error.response?.data?.note || "Something went wrong!");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="flex justify-center mt-6 bg-gray-100">
      ...
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full mt-4 bg-green-600 text-white py-2 rounded-lg hover:bg-green-800 transition duration-300"
        >
