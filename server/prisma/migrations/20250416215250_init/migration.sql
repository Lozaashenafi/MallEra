...
CREATE TABLE `Bid` (
    ...
    `status` ENUM('WINNER', 'DECLINED', 'PENDING') NOT NULL DEFAULT 'PENDING',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `AcceptedUser` (
    ...
    `note` VARCHAR(191) NOT NULL,
    `paymentDateLimit` DATETIME(3) NOT NULL,
    ...
    UNIQUE INDEX `AcceptedUser_requestId_key`(`requestId`),
    UNIQUE INDEX `AcceptedUser_bidId_key`(`bidId`),
    UNIQUE INDEX `AcceptedUser_userId_key`(`userId`),
    UNIQUE INDEX `AcceptedUser_postId_key`(`postId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Refund` (
    ...
    UNIQUE INDEX `Refund_depositId_key`(`depositId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Notification` (
    ...
    `type` ENUM('BID', 'REQUEST', 'MESSAGE', 'SYSTEM', 'ALERT') NOT NULL,
...
CREATE TABLE `RentInfo` (
    ...
    `workingOn` VARCHAR(191) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),

    UNIQUE INDEX `RentInfo_rentId_key`(`rentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
